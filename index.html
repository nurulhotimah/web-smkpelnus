    ...
    <div class="top-bar">
        <div class="container">
            <div class="row">
                ...
                <div class="col-5 contact d-none d-sm-block">
        ...
        <!-- carousel content -->
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/img/pelnus1.jpg" alt="" class="w-100" height="600px">
                ...
                <div class="carousel-item">
                    <img src="assets/img/pelnus3.jpg" alt="" class="w-100" height="600px">
                    <div class="carousel-caption">
                        <div class="container">
                ...
                <div class="carousel-item">
                    <img src="assets/img/pelnus4.jpg" alt="" class="w-100" height="600px">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start text-left">
    ...
    <div class="container">
        <div class="row my-3">
            ...
            <div class="col-md-6 my-4">
                ...
                <div class="btn btn-primary btn-md">Baca Selengkapnya..</div>
            </div>
        </div>
    </div>
...
<!-- End Image Caraousel -->
    ...
    <div class="container">
        <div class="row my-3">
            <div class="col-md-4 my-4">
                <img src="assets/img/p1.jpg" alt="" class="w-100">
            </div>
            <div class="col-md-4 my-4">
                <img src="assets/img/p1.jpg" alt="" class="w-100">
            </div>
            <div class="col-md-4 my-4">
                <img src="assets/img/p3.jpg" alt="" class="w-100">
            </div>
        </div>
    </div>
    <!-- End program keahlian -->
    ...
    <div class="col-12 text-center my-3">
        <a href="#" class="btn btn-primary btn-lg mb-5">Lihat semua guru</a>
    </div>
